...
cout<<"\nIn function";    
cout<<"\nDate:	"<<date.tm_mday<<" : "<<date.tm_mon<<" : "<<date.tm_year;
cout<<"\nTime:	"<<time.tm_hour<<" : "<<time.tm_min;
...
cout<<"Enter the Date in the format: (Date Month Year):	";
cin>>date.tm_mday>>date.tm_mon>>date.tm_year;
cout<<"\nEnter Time: (24 Hour clock)(Hour Min):	";
cin>>time.tm_hour>>time.tm_min;
