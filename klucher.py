...
interval = 0   #interval of mins for data representation
...
interval = int(input("Enter Interval: "))      #Interval
...
val = [0,31,28,31,30,31,30,31,31,30,31,30]
...
for month in range(1,13):
    ...
    while day<=ctr:
        n = day + (month>1)*31 + (month>2)*28 + (month>3)*31 + (month>4)*30 + (month>5)*31 + (month>6)*30 + (month>7)*31 + (month>8)*31 + (month>9)*30 + (month>10)*31 + (month>11)*30
        day+=1
